...
namespace HealthInsuranceApi.Migrations
{
    ...
    public partial class InitialCreate10 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClaimsOfficerProfiles",
                columns: table => new
                {
                    ClaimsOfficerProfileId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EmployeeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Department = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ApprovedClaimsCount = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaimsOfficerProfiles", x => x.ClaimsOfficerProfileId);
                    table.ForeignKey(
                        name: "FK_ClaimsOfficerProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HospitalProviderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalProviders", x => x.HospitalProviderId);
                    table.ForeignKey(
                        name: "FK_HospitalProviders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerProfileId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AgentProfileId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerProfiles_AgentProfiles_AgentProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PremiumAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CoverageRemaining = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_CustomerProfiles_CustomerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalProviderId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_HospitalProviders_HospitalProviderId",
                        column: x => x.HospitalProviderId,
                        principalTable: "HospitalProviders",
                        principalColumn: "HospitalProviderId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_HospitalProviderId",
                table: "Claims",
                column: "HospitalProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimsOfficerProfiles_UserId",
                table: "ClaimsOfficerProfiles",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerProfiles_AgentProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalProviders_UserId",
                table: "HospitalProviders",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_CustomerProfileId",
                table: "Policies",
